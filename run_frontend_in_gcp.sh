...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="project-372918"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="ofir.arbili" # without the @post.bgu.ac.il or @gmail.com part
